...
# YOUR CODE HERE:
# Task 3: Create the JSON alert structure
alert_data = {
    "alert_type": "Brute Force",
    "attacker_ips": attacker_ips
}

# Write the data to a new file called threat_report.json
with open("threat_report.json", "w") as file:
    json.dump(alert_data, file, indent=4)

print(f"[+] Success! {len(attacker_ips)} attacker IPs exported to threat_report.json")
